...
public class TransactionsService {
    ...
    public int getTransactionsCount(int id) {
        return userList.getUserById(id).getTransactionsList().getSize();
    }
    ...
    /**
     * @return Количество уникальных элементов после выполнения метода getUniqueElements(int idUser_1, int idUser_2).<br>
     * Изменяется каждый раз после вызова метода getUniqueElements(int idUser_1, int idUser_2)
     */
